        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <?php } ?>
                    ...
                    ?>
                    <div class="row">
                        <div class="col-xl-4 row <?php if(isset($config['photo']['photo_static'][$type]['watermark-advanced']) && $config['photo']['photo_static'][$type]['watermark-advanced'] == true) { ?> <?php } else{?> d-none<?php } ?>">
                        ...
                        <div class="col-xl-8 row <?php if(isset($config['photo']['photo_static'][$type]['watermark-advanced1']) && $config['photo']['photo_static'][$type]['watermark-advanced1'] == true) { ?> <?php }else{?>  d-none <?php } ?>">
                            <?php /* ?>
                    ...
                    <a class="btn btn-sm bg-gradient-success mb-3 <?php if(isset($config['photo']['photo_static'][$type]['watermark']) && $config['photo']['photo_static'][$type]['watermark'] == true) { ?> <?php }else{?>  d-none <?php } ?>" href="javascript:previewWatermark();"><i class="fas fa-photo-video mr-2"></i>Preivew</a>
