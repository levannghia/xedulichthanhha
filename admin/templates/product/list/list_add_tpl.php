...
<section class="content">
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
            ...
            <div class="<?=$colLeft?>">
                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <div class="form-group">
                            <label for="page" class="d-inline-block align-middle mb-0 mr-2">Số SP phân trang trang chủ:</label>
                            <input type="number" class="form-control form-control-mini d-inline-block align-middle" min="0" name="data[page]" id="page" placeholder="Số SP" value="<?=isset($item['page']) ? $item['page'] : 1?>">
                        </div> -->
        ...
        <?php if(isset($flagGallery) && $flagGallery == true) { 
                $dimension = "Width: ".$config['product'][$type]['gallery_list'][$key]['width_photo']." px - Height: ".$config['product'][$type]['gallery_list'][$key]['height_photo']." px (".$config['product'][$type]['gallery_list'][$key]['img_type_photo'].")";
            ?>
            <div class="card card-primary card-outline text-sm">
                <div class="card-header">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="filer-gallery" class="label-filer-gallery mb-3">Album hình: (<?=$dimension?>)</label>
