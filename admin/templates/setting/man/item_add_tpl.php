	...
	<form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="form-group col-md-4 col-sm-6">
						<label for="sanpham">Số SP phân trang trang trong:</label>
						<input type="text" class="form-control" name="data[options][sanpham]" id="sanpham" placeholder="Số sp" value="<?=$options['sanpham']?>">
					</div>
					<div class="form-group col-md-4 col-sm-6">
						<label for="news">Số bài viết phân trang trang trong:</label>
						<input type="text" class="form-control" name="data[options][news]" id="news" placeholder="Số bài viết" value="<?=$options['news']?>">
					</div>
