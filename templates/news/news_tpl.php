...
<div class="content-main w-clear">
    <?php if(count($news)>0) { for($i=0;$i<count($news);$i++) { ?>
        <a class="news text-decoration-none w-clear" href="<?=$news[$i][$sluglang]?>" title="<?=$news[$i]['ten'.$lang]?>">
            <p class="pic-news scale-img"><img onerror="this.src='<?=THUMBS?>/320x240x2/assets/images/noimage.png';" src="<?=THUMBS?>/320x240x1/<?=UPLOAD_NEWS_L.$news[$i]['photo']?>" alt="<?=$news[$i]['ten'.$lang]?>"></p>
            <div class="info-news">
